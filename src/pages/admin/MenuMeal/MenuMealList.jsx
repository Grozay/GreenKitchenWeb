...
const MenuMealList = () => {
  ...
  const columns = [
    ...
    { field: 'protein', headerName: 'Protein', width: 80, type: 'number', editable: false },
    { field: 'carbs', headerName: 'Carbs', width: 80, type: 'number', editable: false },
    { field: 'fat', headerName: 'Fat', width: 80, type: 'number', editable: false },
    { field: 'price', headerName: 'Price', width: 100, type: 'number', editable: false },
    { field: 'stock', headerName: 'Stock', width: 80, type: 'number', editable: false },
    {
      field: 'type',
      headerName: 'Type',
      width: 120,
